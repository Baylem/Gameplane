...
Per maintainer ruling OD-9 (`specs/017-share-link-expiry/OPEN-DECISIONS.md`), FR-001–FR-004, OD-2, OD-6, and tasks T024/T025 (`specs/017-share-link-expiry/tasks.md`), the create-link dialog's four conditional expiry states were drawn as separate frames rather than stacked into one, following the OD-23 precedent (feature 014's `J5pjJ3` split).
