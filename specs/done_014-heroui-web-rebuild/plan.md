...
| **2a Servers + core tabs** | `014c-servers-core` | `F9pUrx EZFW0 Hy9r0 IzuY2 TE2jI o4LH8W P08Uw Xn5ns kPmoo FtdkI Burtr dPP50 S4k0x I9kvlZ I9W8z JLaGB` | `Servers.tsx`, `ServerDetail.tsx`, tabs Overview/Events/Console/Logs/Files/Players, `components/server/*` cards + dialogs `Jpl8j NVN2r FhrUm` | US2 |
