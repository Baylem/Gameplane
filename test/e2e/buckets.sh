...
TestGameServer_NetworkCaptureRestartCleanup
TestGameServer_NetworkCaptureConcurrencyRejected
TestNetworkCapture_RetentionExpiry
...
TestAddressPool_NonexistentPoolError
